...
export const linkedcorpDescription: INodeProperties[] = [
	{
		...
		options: [
			{ name: '上下游关联客户信息-已添加客户', value: 'getLinkedCustomer', action: '上下游关联客户信息 - 已添加客户', description: '获取上下游企业已添加的客户列表' },
			{ name: '新增对接规则', value: 'addChainRule', action: '新增对接规则', description: '创建新的上下游对接规则' },
			{ name: '更新对接规则', value: 'updateChainRule', action: '更新对接规则', description: '更新已有的上下游对接规则' },
			{ name: '查询成员自定义ID', value: 'getCustomUserId', action: '查询成员自定义 ID', description: '查询成员在上下游企业中的自定义ID' },
			{ name: '移除企业', value: 'removeChainCorp', action: '移除企业', description: '从上下游关系中移除企业' },
			{ name: '获取上下游信息', value: 'getChainInfo', action: '获取上下游信息', description: '获取上下游企业的详细信息' },
			{ name: '获取下级企业加入的上下游', value: 'getSubCorpChainList', action: '获取下级企业加入的上下游', description: '获取下级企业所加入的上下游列表' },
			{ name: '获取下级/下游企业的Access_token', value: 'getLinkedCorpToken', action: '获取下级 / 下游企业的 Access token', description: '获取下级或下游企业的访问令牌' },
			{ name: '获取下级/下游企业小程序Session', value: 'getMiniProgramSession', action: '获取下级 / 下游企业小程序 Session', description: '获取下级或下游企业的小程序会话' },
			{ name: '获取对接规则ID列表', value: 'getChainRuleList', action: '获取对接规则 ID 列表', description: '获取所有对接规则的ID列表' },
			{ name: '获取对接规则详情', value: 'getChainRuleDetail', action: '获取对接规则详情', description: '获取指定对接规则的详细信息' },
			{ name: '获取应用共享信息', value: 'getAppShareInfo', action: '获取应用共享信息', description: '获取应用在上下游企业间的共享信息' },
			{ name: '获取异步任务结果', value: 'getChainAsyncResult', action: '获取异步任务结果', description: '获取上下游异步任务的执行结果' },
			{ name: '删除对接规则', value: 'deleteChainRule', action: '删除对接规则', description: '删除指定的上下游对接规则' },
			{ name: '批量导入上下游联系人', value: 'batchImportChainContact', action: '批量导入上下游联系人', description: '批量导入上下游企业的联系人' },
		],
