		...
		options: [
			{
				...
				values: [
					...
					},
					{
						...
						default: 'Sheet1',
						displayOptions: {
							hide: { request_type: ['add_sheet', 'delete_sheet', 'delete_rows', 'delete_columns'] },
						},
					},
					{
						displayName: '工作表ID',
						name: 'delete_dimension_sheet_id',
						type: 'string',
						default: '',
						displayOptions: { show: { request_type: ['delete_rows', 'delete_columns'] } },
						description: '工作表唯一标识',
					...
					},
					{
						...
						type: 'string',
						default: '',
						displayOptions: { show: { request_type: ['delete_sheet'] } },
						description: '要删除的工作表唯一标识',
						placeholder: '例如: AAAAA',
					},
					{
						displayName: '单元格范围',
					...
					},
					{
						...
						type: 'number',
						default: 1,
						displayOptions: { show: { request_type: ['insert_rows'] } },
					...
					},
					{
						...
						type: 'number',
						default: 1,
						displayOptions: { show: { request_type: ['delete_rows'] } },
						description: '删除行的起始序号（从1开始）',
						typeOptions: { minValue: 1 },
					},
					{
						displayName: '结束行号',
						name: 'delete_end_index',
						type: 'number',
						default: 2,
						displayOptions: { show: { request_type: ['delete_rows'] } },
						description: '删除行的终止序号（从1开始，左闭右开区间）',
						hint: '例如: 起始=1，结束=3，将删除第1和第2行',
					...
					},
					{
						...
						type: 'number',
						default: 1,
						displayOptions: { show: { request_type: ['insert_columns'] } },
					...
					{
						displayName: '起始列号',
						name: 'delete_column_start_index',
						type: 'number',
						default: 1,
						displayOptions: { show: { request_type: ['delete_columns'] } },
						description: '删除列的起始序号（从1开始）',
						typeOptions: { minValue: 1 },
					},
					{
						displayName: '结束列号',
						name: 'delete_column_end_index',
						type: 'number',
						default: 2,
						displayOptions: { show: { request_type: ['delete_columns'] } },
						description: '删除列的终止序号（从1开始，左闭右开区间）',
						hint: '例如: 起始=1，结束=3，将删除第1和第2列',
						typeOptions: { minValue: 2 },
					},
				],
			},
